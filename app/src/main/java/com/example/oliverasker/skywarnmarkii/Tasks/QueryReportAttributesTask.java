...
public class QueryReportAttributesTask extends AsyncTask<Void,Void,Void> {
    ...
    HashMap<String,String> attributesToQuery;
    ...
    protected Void doInBackground(Void... params) {
        ...
        for(String s: attributesToQuery.keySet()){
            Log.i(TAG, "key: " + s + " value: " + attributesToQuery.get(s));
            Condition queryCondition = new Condition()
                    .withComparisonOperator(ComparisonOperator.CONTAINS)
                    .withAttributeValueList(new AttributeValue().withS(attributesToQuery.get(s)));
...
//                test.setDateSubmittedString("2/2/2");
    ...
    public void setAttributesToQuery(HashMap<String, String> attributesToQuery) {
