...
public class SevereViewReportFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstance){
        ...
        DownedTrees = (TextView)view.findViewById(R.id.downed_trees_field_tv);
        DownedTrees.setText(values.get("DownedTrees"));

        DownedLimbs = (TextView)view.findViewById(R.id.downed_limbs_field_tv);
        DownedLimbs.setText(values.get("DownedLimbs"));

        DownedPoles = (TextView)view.findViewById(R.id.downed_poles_field_tv);
        DownedPoles.setText(values.get("DownedPoles"));

        DownedWires= (TextView)view.findViewById(R.id.downed_wires_field_tv);
        DownedWires.setText(values.get("DownedWires"));
